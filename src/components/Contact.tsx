...
import { Mail, Phone, MapPin, WatchIcon, Timer } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div className="lg:col-span-5">
            <Card>
              <CardHeader>
                <CardTitle>Sri Durga's Vocational Training Institute</CardTitle>
                <CardDescription>
              ...
              <CardContent className="pt-6">
                <div className="flex items-start gap-4 pt-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">+91 92473 92736, +91 94916 01636</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 pt-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">sridurgasvocationaltraininginstitute@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 pt-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Monday to Friday: 10 AM to 2 PM</p>
                  </div>
                </div>
              </CardContent>
            </Card>
